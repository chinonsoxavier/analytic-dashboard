...
const Sidebar = () => {
  ...
  return (
    <div className="bg-primary_dark_bg  h-full bd b border-primary_border border-r-[1px] flex w-16 md:w-20 flex-col items-center justify-between  shrink-0">
      <div className="flex items-center justify-center leading-3 flex-col w-full">
        ...
        <div
          className="bg-white rounded-[100px] flex items-center justify-center flex-col pt-2 gap-2 box-border mt-2"
        >
