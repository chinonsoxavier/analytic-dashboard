  ...
  return (
    <div className="w-full p-5 plus_jakarta_sans_semibold">
      <div className="flex items-start gap-4 flex-wrap justify-between h-[400px] ">
        <div className=" bg-white flex items-center justify-start flex-col gap-[2px] rounded-lg border w-full h-full border-primary_border box-border p-4 ">
          <div className="h-[16%] flex flex-col items-center justify-between w-full">
            <div className="flex pb-2  items-center justify-between w-full">
              <p className="plus_jakarta_sans_semibold font-semibold text-lg text-[#26282C]">
                Last Orders
              </p>
              <p className="plus_jakarta_sans_semibold font-medium text-[#34CAA5] text-lg cursor-pointer">
                See All
              </p>
            </div>
            <div
              style={{ gridTemplateColumns: "2fr 1fr 1fr 1fr 1fr" }}
              className="border-b grid  border-primary_border w-full pb-2"
            >
              <div className="flex items-start justify-start">
                <p className="text-[#9CA4AB] w-full text-base font-medium">
                  Name
                </p>
              </div>
              <div className="flex items-start justify-start">
          ...
          <div className="w-full h-[84%] overflow-y-scroll custom_scrollbar">
              ...
              {data.map((item, index) => (
                ...
                >
                  <div className="flex  items-center justify-center gap-2">
                    ...
                    <p className="text-[#3A3F51] w-full text-base font-medium whitespace-nowrap">
                      Marcus Bergson
                    </p>
                  </div>
                  <div className="flex items-center justify-start">
                    <p className="text-[#3A3F51] w-full text-base font-medium">
                      Nov 15,2023
                    </p>
                  </div>
                  <div className="flex items-center justify-start">
                    <p className="text-[#3A3F51] w-full text-base font-semibold">
                      $60,00.00
                    </p>
                  </div>
                  <div className="flex items-center justify-start">
                    <p className="text-[#34CAA5] w-full text-base font-normal">
                      Paid
                    </p>
                  </div>
                  <div className="w-[40px] flex items-center justify-center gap-[6px]">
                    ...
                    <p className="text-[#3A3F51] w-full text-sm font-normal">
                      View
                    </p>
                  </div>
                </div>
        ...
        <div className="basis-[300px] h-full bg-white border border-primary_border rounded-lg  box-border p-4  ">
          <div className="flex items-center justify-between w-full mb-3 h-[12%]">
            <p className="plus_jakarta_sans_semibold font-semibold text-lg text-[#26282C]">
              Top Platforms
            </p>
            <div className="flex items-center justify-center gap-2">
              <p className="plus_jakarta_sans_semibold font-medium text-lg text-[#34CAA5] cursor-pointer">
                See All
              </p>
            </div>
          </div>
          <div className="w-full h-[88%] custom_scrollbar overflow-y-scroll">
            {/* {data.map((item, i) => ( */}
            <div className="gap-2 flex flex-col items-start justify-start">
              <div>
                <p className="text-lg font-medium text-[#22242C] text-left">
                  Artisan Aisle
                </p>
              </div>
              <div className="w-full rounded-full h-2 relative bg-[#F5F5F5]">
                <div className="absolute rounded-full h-full w-[60%] bg-[#6160DC] left-0"></div>
              </div>
              <div className="flex items-center justify-between w-full">
                <p className="text-sm font-normal"> $2,500,000</p>
            ...
            <div className="gap-2 flex flex-col items-start justify-start">
              ...
              <div className="flex items-center justify-between w-full">
                <p className="text-sm font-normal"> $1,800,000</p>
            ...
            <div className="gap-2 flex flex-col items-start justify-start">
              ...
              <div className="flex items-center justify-between w-full">
                <p className="text-sm font-normal"> $1,200,000</p>
                <p className="text-sm font-normal"> + 8%</p>
              </div>
            </div>
            <div className="gap-2 flex flex-col items-start justify-start">
              <div>
              ...
              <div className="flex items-center justify-between w-full">
                <p className="text-sm font-normal"> $1,200,000</p>
                <p className="text-sm font-normal"> + 26%</p>
              </div>
            </div>
            <div className="gap-2 flex flex-col items-start justify-start">
              <div>
              ...
              <div className="flex items-center justify-between w-full">
                <p className="text-sm font-normal"> $1,900,000</p>
            ...
            <div className="gap-2 flex flex-col items-start justify-start">
              ...
              <div className="flex items-center justify-between w-full">
                <p className="text-sm font-normal"> $1,000,000</p>
                <p className="text-sm font-normal"> + 6%</p>
              </div>
            </div>
            {/* ))} */}
          </div>
