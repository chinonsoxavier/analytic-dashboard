  ...
  return (
    <div className="bg-primary_dark_bg flex items-center justify-evenly w-full py-5 px-2 gap-4 border-b  z-50 border-b-primary_border">
      ...
      <div className="flex-1">
        <div className="bg-[#fff] flex items-center justify-center border border-[#DADDDD] rounded-3xl h-8 md:h-10 w-full px-2 relative flex-1">
          <svg
            className="w-3 h-3"
          ...
          <input
            className="pl-2 w-full border-none h-full relative rounded-3xl outline-none bg-transparent placeholder:text-sm font-normal inter_normal"
            placeholder="Search..."
          />
        </div>
      </div>
      <div className="flex-1 lmd:hidden">
        <div className="flex items-center justify-center gap gap-[2px]">
          <svg
          className='w-4 h-4'
            xmlns="http://www.w3.org/2000/svg"
            width="20"
          ...
          <p className="text-base plus_jakarta_sans_semibol font-normal text-center bg-blac">
            November 15, 2023
          </p>
        </div>
      </div>
      <div className="hidden items-center justify-between md:flex ">
        <div className="border border-[#DADDDD] rounded-[27px] flex items-center justify-center w-10 h-10">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
      ...
      <div className=" flex xs:hidden items-center justify-between">
        <div className="flex items-center justify-between rounded-[28px] gap-2 border-primary_border border px-2">
          ...
          <div className="flex items-end justify-end flex-col">
            <p className="text-sm font-normal inter_normal text-[#26282C] md:text-base ">
              {" "}
              Justin Bergson{" "}
            </p>
            <p className="gg text-ellipsis block overflow-hidden inter_normal basi basis-2/5 text-xs md:text-sm">
              Justin@gmail.com
            </p>
          </div>
